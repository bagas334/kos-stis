<div class="overflow-y-scroll no-scrollbar flex flex-col items-center justify-start w-full h-20 py-2">
    <div>
        ...
        <svg class="size-6 mb-1" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
  ...
  c44.523,19.453,68.805,0,68.805,0V278.915h-64.758L382.453,430.556z" />
                ...
                <rect x="262.664" y="107.222" transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 298.3835 572.0344)"
                    class="st0" width="9.999" height="233.997" />

                <rect x="295.879" y="225.346" transform="matrix(0.7071 0.7071 -0.7071 0.7071 304.7441 -123.027)"
                    class="st0" width="9.999" height="161.999" />
            </g>
        </svg>
    </div>
    <span class="sm:text-base text-center text-sm text-gray-600 averia-serif-libre-regular">Jendela</span>
</div>
